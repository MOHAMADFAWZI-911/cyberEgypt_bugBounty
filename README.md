# BugBounty Demo ‚Äî Full Stack (React + json-server + Docker)

## Ì†ΩÌ≥ù Project Summary
...
## Ì†ΩÌ≤ª Tech Stack & Architecture
...
## Ì†ΩÌ∫Ä Deployment to AWS EC2 via Docker
...
Ì†ΩÌª†Ô∏è Local Development (Without Docker)
